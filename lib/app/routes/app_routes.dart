...
abstract class Routes {
  ...
  static const USER_PACKAGE_DETAILS = _Paths.USER_PACKAGE_DETAILS;
  static const ADMIN_DASHBOARD = _Paths.ADMIN_DASHBOARD;
  static const EVENT_CREATE = _Paths.EVENT_CREATE;
  static const ALL_EVENTS = _Paths.ALL_EVENTS;
  static const TOTAL_COST = _Paths.TOTAL_COST;
...
abstract class _Paths {
  ...
  static const USER_PACKAGE_DETAILS = '/user-package-details';
  static const ADMIN_DASHBOARD = '/admin-dashboard';
  static const EVENT_CREATE = '/event-create';
  static const ALL_EVENTS = '/all-events';
  static const TOTAL_COST = '/all-users';
